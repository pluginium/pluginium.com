...
export const metadata: Metadata = {
  ...
  description:
    'Discover the guidelines shaping our partnership journey, outlined meticulously for your understanding and assurance.',
  openGraph: {
    url: 'https://pluginum.com/terms',
  },
}
      ...
      <ContentContainer>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Pluginium LLC.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Pluginium, accessible from{' '}
              <Link href="/">https://pluginium.com</Link>
            </p>
          </li>
          <li>
            <p>
        ...
        <ul>
          <li>
            <p>
              By email:{' '}
              <Link href="mailto:terms@pluginium.com">terms@pluginium.com</Link>
            </p>
          </li>
          <li>
            <p>
              By visiting this page on our website:{' '}
              <Link href="/contact">https://pluginium.com/contact</Link>
            </p>
          </li>
        </ul>
      </ContentContainer>
