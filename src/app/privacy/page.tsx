...
const description =
  'Protecting your data is our top priority for transparency, security, and peace of mind.'

export const metadata: Metadata = {
  title: 'Privacy Policy',
  description,
  openGraph: {
    url: 'https://pluginium.com/privacy',
  },
}
...
export default function Privacy() {
  return (
    <>
      <PageHeader subtitle={description}>Privacy Policy</PageHeader>
      ...
      <ContentContainer>
        ...
        <ul>
          <li>
            <p>
              By email:{' '}
              <Link href="mailto:privacy@pluginium.com">
                privacy@pluginium.com
              </Link>
            </p>
          </li>
          <li>
